...
from nanobot.agent import context_governance as _context_governance
...
_BACKFILL_CONTENT = _context_governance.BACKFILL_CONTENT
_COMPACTABLE_TOOLS = _context_governance.COMPACTABLE_TOOLS
_MICROCOMPACT_KEEP_RECENT = _context_governance.MICROCOMPACT_KEEP_RECENT
_MICROCOMPACT_MIN_CHARS = _context_governance.MICROCOMPACT_MIN_CHARS
_SNIP_SAFETY_BUFFER = _context_governance.SNIP_SAFETY_BUFFER
_TOOL_RESULT_OFFLOAD_EXEMPT_TOOLS = _context_governance.TOOL_RESULT_OFFLOAD_EXEMPT_TOOLS
...
__all__ = [
    ...
    "_SNIP_SAFETY_BUFFER",
    "_TOOL_RESULT_OFFLOAD_EXEMPT_TOOLS",
]
